from sem14.task2.last_works import Matrix
...
def test_matrix():
    ...
    ...
    sem14.task02.custom_exceptions.MatrixExc.MatrixTypeError: AN ERROR OCCURRED. MatrixTypeError: 2 is not a 'Matrix' instance
    """
    ...
